					...
					<tbody>
						<tr>
								...
								<div class="media">
									...
									<div class="media-body">
										<h4 class="media-heading">
											<a href="#">${SCHUH.modell}</a>
										</h4>
										<h5 class="media-heading">
											by <a href="#">${SCHUH.marke}</a>
										</h5>
							...
							<td class="col-sm-1 col-md-1" style="text-align: center"><input
								...
								value="3"></td>
							<td class="col-sm-1 col-md-1 text-center"><strong>${SCHUH.preis}</strong></td>
							<td class="col-sm-1 col-md-1 text-center"><strong>${SCHUH.preis}</strong></td>
						...
						<tr>
							...
							<td class="col-md-1" style="text-align: center"><input
								type="email" class="form-control" id="exampleInputEmail1"
								value="2"></td>
							<td class="col-md-1 text-center"><strong>$88</strong></td>
							<td class="col-md-1 text-center"><strong>$666</strong></td>
							<td class="col-md-1">
								<button type="button" class="btn btn-danger">
									<span class="glyphicon glyphicon-remove"></span> Löschen
								</button>
